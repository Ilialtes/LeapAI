...
import { Bookmark, CheckCircle2, Flame, Sparkles, Target, Plus, ArrowLeft } from 'lucide-react';
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.success) {
          ...
          // Update achievement tracking for goals
          const totalGoals = data.goals.length;
          const completedGoals = data.goals.filter((goal: any) => goal.status === 'completed').length;
      ...
      <main className="max-w-7xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-10 my-6 sm:my-8">
        <div className="flex items-center justify-between mb-8 sm:mb-10">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold" style={{color: '#2E7D32'}}>
              Your Goals
            </h1>
          </div>
          <button
            onClick={() => setIsCreateModalOpen(true)}
            className="text-white font-semibold py-2 px-4 rounded-lg flex items-center gap-2 transition-colors"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-100">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-lg font-semibold" style={{color: '#2E7D32'}}>Today's Check-ins</h3>
            </div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-6 border border-orange-100">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-lg font-semibold" style={{color: '#D84315'}}>Best Streak</h3>
            </div>
        ...
        <div className="flex flex-col gap-8 sm:gap-10">
          <section>
            <div className="flex items-center gap-2 mb-4 sm:mb-6">
              ...
              <h2 className="text-xl sm:text-2xl font-semibold" style={{color: '#546E7A'}}>
                Your Goals
              </h2>
            </div>
            <TopGoalsSection />
