        ...
        <div className="flex items-center h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold" style={{color: '#2E7D32'}}>SubtlePush</span>
            </Link>
          </div>
          ...
          {user && (
            <div className="md:hidden ml-2" ref={mobileMenuRef}>
              ...
              {isMobileMenuOpen && (
                <div className="absolute right-4 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                  {navItems.map((item) => {
                    const Icon = item.icon;
                    return (
                      <Link
